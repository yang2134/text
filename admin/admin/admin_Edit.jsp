...
<input name="adminaccount" type="text" id="adminaccount" style="width: 200px;" required  value='${admin.adminaccount}' />
 </td></tr>

<tr><td  style="text-align:right; width:20%;">
<font style='color:red'>*&nbsp;</font>管理员密码:</td><td>
<input name="adminpassword" type="text" id="adminpassword" style="width: 200px;" required  value='${admin.adminpassword}' />
 </td></tr>
        ...
        <tr>
            <td>&nbsp;</td>
            <td align="left">
                <input name="adminid" type="hidden"  value='<%= request.getParameter("id") %>'>
