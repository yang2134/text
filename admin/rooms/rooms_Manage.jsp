...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 <jsp:include flush="true" page="${basePath}/admin/head.jsp"></jsp:include>     
  ...
  <body>
    ...
    <tr>
        <td>
            <pg:pager  url="roomsList.action" items="${itemSize}" maxPageItems="${pageItem}"
    ...
    <table style="width:100%;text-align: center" id="show_tab">
        ...
        <td>${rooms.rname}</td>
<td>
        <a href="<%=path %>/toroomsEdit.action?id=${rooms.rid}" class="cu-tag bg-green light "><i class="glyphicon glyphicon-pencil"></i>编辑</a>&nbsp;
<a href="javascript:void(0)" onclick="showMsg3('<%=path%>/roomsDel.action','${rooms.rid}')" class="cu-tag bg-red light "><i class="glyphicon glyphicon-remove"></i>删除</a>&nbsp;
        </td>
        </tr>
