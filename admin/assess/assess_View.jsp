...
ID:</td><td>${assess.aid} </td></tr>

            <tr><td  style="text-align:right; width:20%;    padding-right: 15px; ">
电影:</td><td>${assess.title} </td></tr>

            <tr><td  style="text-align:right; width:20%;    padding-right: 15px; ">
用户id:</td><td>${assess.meid} </td></tr>

            <tr><td  style="text-align:right; width:20%;    padding-right: 15px; ">
评分:</td><td>${assess.ascore} </td></tr>

            <tr><td  style="text-align:right; width:20%;    padding-right: 15px; ">
评语:</td><td>${assess.amemo} </td></tr>

            <tr><td  style="text-align:right; width:20%;    padding-right: 15px; ">
评论时间:</td><td>${assess.atime} </td></tr>
