 ...
 <jsp:include flush="true" page="${basePath}/admin/head.jsp"></jsp:include>     
  ...
  <body>
        ...
        <div style="width: 100%; padding: 20px;line-height: 29px;">
            <form  action="<%=path %>/mtypeEdit.action" method="post"  id="form1">
    <table style="width: 100%;" id="show_tab">
        
<tr><td  style="text-align:right; width:20%;">
<font style='color:red'>*&nbsp;</font>分类名称:</td><td>
<input name="tname" type="text" id="tname" style="width: 200px;" required  value='${mtype.tname}' />
 </td></tr>
        ...
        <tr>
            <td>&nbsp;</td>
            <td align="left">
                <input name="tid" type="hidden"  value='<%= request.getParameter("id") %>'>
