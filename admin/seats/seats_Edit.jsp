 ...
 <jsp:include flush="true" page="${basePath}/admin/head.jsp"></jsp:include>     
  ...
  <body>
        ...
        <div style="width: 100%; padding: 20px;line-height: 29px;">
            <form  action="<%=path %>/seatsEdit.action" method="post"  id="form1">
...
<option value="${rooms.rid}"   <c:if test="${rooms.rid==seats.rid}"> selected="selected"</c:if> >${rooms.rname}</option>
</c:forEach>
</select>
...
<input name="pai" type="text" id="pai" style="width: 200px;"   value='${seats.pai}' />
 </td></tr>

<tr><td  style="text-align:right; width:20%;">
<font style='color:red'>*&nbsp;</font>号:</td><td>
<input name="hao" type="text" id="hao" style="width: 200px;"   value='${seats.hao}' />
 </td></tr>
        ...
        <tr>
            <td>&nbsp;</td>
            <td align="left">
                <input name="sid" type="hidden"  value='<%= request.getParameter("id") %>'>
