...
<img src='<%=path %>/${news.photo}' style="width: 80px;height: 80px">
<input type="text" name="photo" id="fujian" size="50"  value='${news.photo}' readonly="readonly" />
...
<textarea id="memo"  name="memo" cols="100" rows="8" style="width:700px;height:400px;visibility:hidden;">${news.memo}</textarea>
 </td></tr>
