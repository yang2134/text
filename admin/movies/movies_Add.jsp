 ...
 <jsp:include flush="true" page="${basePath}/admin/head.jsp"></jsp:include>     
  ...
  <body>
        ...
        <div style="width: 100%; padding: 20px;line-height: 29px;">
            <form  action="<%=path %>/moviesAdd.action" method="post" id="form1">
...
<input type="text" name="pic" id="fujian" size="50" readonly="readonly" />
<input type="button" value="上传" onclick="up2()" />
 </td></tr>

<tr><td  style="text-align:right; width:20%;">
<font style='color:red'>*&nbsp;</font>导演:</td><td>
<input name="daoy" type="text" id="daoy" style="width: 200px;" required />
 </td></tr>

<tr><td  style="text-align:right; width:20%;">
<font style='color:red'>*&nbsp;</font>主演:</td><td>
<input name="zhuy" type="text" id="zhuy" style="width: 200px;" required />
 </td></tr>

<tr><td  style="text-align:right; width:20%;">
<font style='color:red'>*&nbsp;</font>时长:</td><td>
<input name="shic" type="text" id="shic" style="width: 200px;" required />
 </td></tr>
...
<textarea id="memo"  name="memo" cols="100" rows="8" style="width:700px;height:400px;visibility:hidden;"></textarea>
        ...
        <tr>
            ...
            <td align="left">
                ...
                <input name="btnReturn" type="button" value="返 回"   class=" btn btn-success mb-2 mr-2"  onclick="location.href='<%=path %>/moviesList.action';"  />
            </td>
        </tr>
    </table>
</form>
